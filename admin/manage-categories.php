...
<?php elseif(isset($_SESSION['add-category'])) :  /// shows if add category was succesful ?>
...
<?php elseif(isset($_SESSION['delete-category'])) :  /// shows if deleted category was succesful ?>
                <div class="alert__message success container">
                    <p> 
    ...
    <div class="container dashboard__container">
        ...
        <aside>
            <ul>
                ...
                <li><a href="index.php"> <i class="uil uil-pen"></i><h5> Manage Post</h5></a></li>
